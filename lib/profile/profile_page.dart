...
class _ProfilePageState extends State<ProfilePage> with SingleTickerProviderStateMixin {
                    ...
                    Container(
                      ...
                      child: TabBar(
                        ...
                        tabs: const [
                          ...
                          Tab(
                            icon: FaIcon(FontAwesomeIcons.mapLocation, size: 18),
                          ),
                  ],
                ),
              ),
  ...
  Widget _buildLocationTab(bool isDark) {
    ...
    debugPrint('ProfileInformation: Building location tab, location data: ${userData!['location']}');
    
    // Check if location data exists
    if (userData!['location'] == null) {
      debugPrint('ProfileInformation: Location is null');
      return Center(
        child: Padding(
          padding: const EdgeInsets.all(40),
          child: Column(
    ...
    debugPrint('ProfileInformation: Location data parsed: $locationData');
    
    if (locationData['latitude'] == null || locationData['longitude'] == null) {
      debugPrint('ProfileInformation: Latitude or longitude is null');
      debugPrint('ProfileInformation: Latitude: ${locationData['latitude']}, Longitude: ${locationData['longitude']}');
      return Center(
        child: Padding(
          padding: const EdgeInsets.all(40),
          child: Column(
