...
class _ProfileInformationPageState extends State<ProfileInformationPage> {
  ...
  String _getJoinedRoomsCount() {
    try {
      ...
      print('ProfileInformation: Error getting joined rooms count: $e');
      return '0';
    }
  }
  ...
  String _getActiveHours() {
    try {
      ...
      print('ProfileInformation: Error getting active hours: $e');
      return 'Belirsiz';
    }
  }
  ...
  String _getBirthDateInfo() {
    try {
      ...
      print('ProfileInformation: Error getting birth date info: $e');
      return 'Doğum tarihi yok';
    }
  }
